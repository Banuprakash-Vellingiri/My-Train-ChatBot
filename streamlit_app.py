...
def handle_query(llm,db,user_question):
  try:
        ...
        query = generate_query.invoke({"question":user_question,"prompt":"create sql query if the query is like what is the travel durstion create a new column ad calculate the travel duration with available resource columns"})
...
if 'generated' not in st.session_state:
        st.session_state['generated'] = ["👋 Hello, Ask Me About Train Schedule 🚊"]
